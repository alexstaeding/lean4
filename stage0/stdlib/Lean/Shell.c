...
fprintf(stderr, "[Lean Shell Init] Starting\n");
fflush(stderr);
lean_object * res;
fprintf(stderr, "[Lean Shell Init] Checking _G_initialized\n");
fflush(stderr);
if (_G_initialized) return lean_io_result_mk_ok(lean_box(0));
_G_initialized = true;
fprintf(stderr, "[Lean Shell Init] _G_initialized is false\n");
fflush(stderr);
fprintf(stderr, "[Lean Shell Init] Calling initialize_Lean_Elab_Frontend\n");
fflush(stderr);
...
fflush(stderr);
lean_dec_ref(res);
fprintf(stderr, "[Lean Shell Init] Calling initialize_Lean_Elab_ParseImportsFast\n");
fflush(stderr);
...
fflush(stderr);
lean_dec_ref(res);
fprintf(stderr, "[Lean Shell Init] Calling initialize_Lean_Server_Watchdog\n");
fflush(stderr);
...
fflush(stderr);
lean_dec_ref(res);
fprintf(stderr, "[Lean Shell Init] Calling initialize_Lean_Server_FileWorker\n");
fflush(stderr);
...
fflush(stderr);
lean_dec_ref(res);
fprintf(stderr, "[Lean Shell Init] Calling initialize_Lean_Compiler_IR_EmitC\n");
fflush(stderr);
